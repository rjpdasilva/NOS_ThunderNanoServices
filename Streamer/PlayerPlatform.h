...
namespace Player {
    ...
    namespace Implementation {
        ...
        struct IPlayerPlatform {
            ...
            virtual uint32_t Setup(uint8_t mode) = 0;
        ...
        struct IPlayerPlatformFactory {
            ...
            virtual IPlayerPlatform* Create(uint8_t mode) = 0;
        ...
        public:
            ...
            IPlayerPlatform* Create(uint8_t mode) override
            {
                ...
                if (index < _slots.Size()) {
                    ...
                    if ((player != nullptr) && (player->Setup(mode) != Core::ERROR_NONE)) {
